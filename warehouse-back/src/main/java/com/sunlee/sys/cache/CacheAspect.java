...
public class CacheAspect {
     ...
     * 声明部门的切面表达式
     */
    private static final String POINTCUT_DEPT_ADD="execution(* com.sunlee.sys.service.impl.DeptServiceImpl.save(..))";
    private static final String POINTCUT_DEPT_UPDATE="execution(* com.sunlee.sys.service.impl.DeptServiceImpl.updateById(..))";
    private static final String POINTCUT_DEPT_GET="execution(* com.sunlee.sys.service.impl.DeptServiceImpl.getById(..))";
    private static final String POINTCUT_DEPT_DELETE="execution(* com.sunlee.sys.service.impl.DeptServiceImpl.removeById(..))";
