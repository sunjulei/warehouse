...
INSERT INTO `bus_retail` VALUES (1,NULL,0,1,'现金','2026-06-06 02:51:24','超级管理员',1,'',12.50,0),(2,NULL,0,2,'现金','2026-06-07 15:16:44','超级管理员',1,'',38.00,0),(3,'RO17809045055824184',0,1,'现金','2026-06-08 07:41:46','超级管理员',2,'',12.50,0),(4,'RO17809045055824184',1,5,'现金','2026-06-08 07:41:46','超级管理员',0,'',28.00,0),(5,'RO17809045055824184',0,5,'现金','2026-06-08 07:46:26','超级管理员',1,NULL,28.00,0),(6,'RO17809045055824184',0,6,'现金','2026-06-08 07:46:35','超级管理员',2,NULL,22.00,0),(7,'RO17809051828485725',1,1,'微信','2026-06-08 07:53:03','超级管理员',0,'阿斯顿啊实打实大天气好犬瘟热请问请问恶趣味去问驱蚊器恶趣味驱蚊器',12.50,0),(8,'RO17809051828485725',1,16,'微信','2026-06-08 07:53:03','超级管理员',0,'阿斯顿啊实打实大天气好犬瘟热请问请问恶趣味去问驱蚊器恶趣味驱蚊器',48.00,0),(9,'RO17809051828485725',1,4,'微信','2026-06-08 07:53:03','超级管理员',0,'阿斯顿啊实打实大天气好犬瘟热请问请问恶趣味去问驱蚊器恶趣味驱蚊器',10.00,0),(10,'RO17809054254036216',0,3,'银行卡','2026-06-08 07:57:05','超级管理员',1,'破解破解阿达帕加的爬升到的帕松大师欸日瑞特瑞特让他',8.50,0),(11,'RO17809054254036216',0,8,'银行卡','2026-06-08 07:57:05','超级管理员',1,'破解破解阿达帕加的爬升到的帕松大师欸日瑞特瑞特让他',9.80,0);
/*!40000 ALTER TABLE `bus_retail` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bus_retail_log`
--

DROP TABLE IF EXISTS `bus_retail_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bus_retail_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='零售操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bus_retail_log`
--

LOCK TABLES `bus_retail_log` WRITE;
/*!40000 ALTER TABLE `bus_retail_log` DISABLE KEYS */;
INSERT INTO `bus_retail_log` VALUES (1,'RO17809045055824184',1,'retail',2,12.5,'现金','超级管理员','2026-06-08 07:41:46',''),(2,'RO17809045055824184',5,'retail',1,28,'现金','超级管理员','2026-06-08 07:41:46',''),(3,'RO17809045055824184',5,'add',1,28,'现金','超级管理员','2026-06-08 07:46:26',NULL),(4,'RO17809045055824184',6,'add',2,22,'现金','超级管理员','2026-06-08 07:46:35',NULL),(5,'RO17809045055824184',5,'return',1,28,'现金','超级管理员','2026-06-08 07:51:38','单商品退货（全部）'),(6,'RO17809051828485725',1,'retail',1,12.5,'微信','超级管理员','2026-06-08 07:53:03','阿斯顿啊实打实大天气好犬瘟热请问请问恶趣味去问驱蚊器恶趣味驱蚊器'),(7,'RO17809051828485725',16,'retail',2,48,'微信','超级管理员','2026-06-08 07:53:03','阿斯顿啊实打实大天气好犬瘟热请问请问恶趣味去问驱蚊器恶趣味驱蚊器'),(8,'RO17809051828485725',4,'retail',1,10,'微信','超级管理员','2026-06-08 07:53:03','阿斯顿啊实打实大天气好犬瘟热请问请问恶趣味去问驱蚊器恶趣味驱蚊器'),(9,'RO17809054254036216',3,'retail',1,8.5,'银行卡','超级管理员','2026-06-08 07:57:05','破解破解阿达帕加的爬升到的帕松大师欸日瑞特瑞特让他'),(10,'RO17809054254036216',8,'retail',1,9.8,'银行卡','超级管理员','2026-06-08 07:57:05','破解破解阿达帕加的爬升到的帕松大师欸日瑞特瑞特让他'),(11,'RO17809051828485725',1,'return',1,12.5,'微信','超级管理员','2026-06-08 07:59:21','整单退货'),(12,'RO17809051828485725',16,'return',2,48,'微信','超级管理员','2026-06-08 07:59:21','整单退货'),(13,'RO17809051828485725',4,'return',1,10,'微信','超级管理员','2026-06-08 07:59:21','整单退货');
/*!40000 ALTER TABLE `bus_retail_log` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='退加货操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_stocktake` VALUES (1,'ST20260606091742',2,'超级管理员','测试','2026-06-06 01:17:42',NULL),(2,'ST20260606112120',1,'超级管理员','','2026-06-06 03:21:21','2026-06-06 03:24:22'),(3,'ST20260606113058',2,'超级管理员','','2026-06-06 03:30:59',NULL),(4,'ST20260609085022',0,'超级管理员','1','2026-06-09 00:50:23',NULL);
...
CREATE TABLE `sys_loginfo` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=258 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_permission` (
  ...
  `available` int DEFAULT NULL COMMENT '状态【0不可用1可用】',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=168 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-10 10:05:41
