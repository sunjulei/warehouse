<template>
  <div>
    <div class="page-header animate-fade-in-up">
      <h1 class="page-header-title">进销金额分析</h1>
      <p class="page-header-desc">按时间段统计进货与销售金额</p>
    </div>
        ...
        <div class="card-header">
          <div class="card-header-left">
            ...
            <div class="header-text-group">
              <span class="header-title">进货金额统计</span>
              <span class="header-subtitle">选择时间段查看进货趋势</span>
            </div>
          </div>
      ...
      <template #header>
        <div class="card-header">
          <div class="card-header-left">
            ...
            <div class="header-text-group">
              <span class="header-title">销售金额统计</span>
              <span class="header-subtitle">选择时间段查看销售趋势</span>
            </div>
          </div>
          <div class="card-header-right">
