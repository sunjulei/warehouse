<template>
  <div class="page-container">
    <div class="page-header animate-fade-in-up">
      <h1 class="page-header-title">会员管理</h1>
    ...
    <!-- 充值/消费记录弹窗 -->
    <el-dialog v-model="recordsDialogVisible" title="储值卡流水" width="650px">
      <el-table :data="memberRecords" border stripe size="small">
        ...
        <el-table-column prop="amount" label="金额" width="100" align="right">
          <template #default="{ row }">
            <span :style="{ color: row.type === '消费' ? 'var(--danger-color)' : 'var(--success-color)' }">
...
function levelText(level: number) {
  return { 1: '普通', 2: '银卡', 3: '金卡', 4: '钻石' }[level] ?? '普通'
}
