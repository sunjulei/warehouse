...
/*!40000 ALTER TABLE `bus_goods`
    DISABLE KEYS */;
INSERT INTO `bus_goods` (`id`, `goodsname`, `providerid`, `categoryid`, `produceplace`, `size`, `goodspackage`, `productcode`, `promitcode`, `description`, `price`, `number`, `dangernum`, `goodsimg`, `available`)
